...
export interface AIClassificationInput {
  ...
  description: string;
  address: string;
  district: string; // name of the citizen-selected district
...
## Response Format:
{
  ...
  private static async analyzeWithImage(textPrompt: string, imagePath: string): Promise<AIClassificationResult> {
