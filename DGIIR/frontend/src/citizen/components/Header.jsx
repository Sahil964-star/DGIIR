  ...
  return (
    <header className="h-20 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed top-0 right-0 left-[260px] flex items-center justify-between px-8 z-10 transition-colors">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Let's make our city a better place together.</p>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Notifications */}
        <button className="relative p-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-700 rounded-full transition-colors">
