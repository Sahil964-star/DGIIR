...
export declare const getCmOverview: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getTopConcerns: (req: Request, res: Response, next: import("express").NextFunction) => void;
