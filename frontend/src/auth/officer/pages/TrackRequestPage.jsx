          ...
          <div className="w-full max-w-2xl">
            <div className="mb-8 text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Monitor the verification status of your government field access profile.
              </p>
            </div>
            ...
            <Card className="p-8 bg-white/80 dark:bg-[#111827]/90 backdrop-blur-sm border border-slate-200 dark:border-[#1f2937]">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-6 mb-8">
                <div>
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white">REQ-2026-0042</h3>
                  <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mt-1">Delhi Jal Board • Submitted Oct 14, 2026</p>
                </div>
              ...
              {/* Timeline */}
              <RequestTimeline currentStatus="review" />
              ...
              <div className="mt-10 p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                <strong className="text-slate-900 dark:text-white">Next Steps:</strong> Operations validation is currently in progress. Your submitted ID and Appointment Letter are being verified against centralized department records. This process typically takes 24-48 hours.
              </div>
            </Card>
