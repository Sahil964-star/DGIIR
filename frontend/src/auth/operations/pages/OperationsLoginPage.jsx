...
import OperationsLoginForm from '../components/OperationsLoginForm';
import ThemeToggle from '../components/ThemeToggle';
import Card from '../../../shared/components/Card';

const OperationsLoginPage = () => {
    ...
    >
      ...
      <div className="flex-1 flex flex-col relative w-full lg:w-[55%]">
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
          <Card className="w-full max-w-[600px] p-8 sm:p-10 relative z-10 border border-slate-200 dark:border-slate-800" animate>
            <OperationsLoginForm />
          </Card>
        </div>
      </div>
