...
import { CheckCircle2, FileText, Building2, Clock } from 'lucide-react';
        ...
        <div className="flex-1 flex items-center justify-center p-8 sm:p-12 relative z-10">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-md mx-auto leading-relaxed">
              Your request has been forwarded for administrative review.
            </p>
            
            {/* Immutable Request Metric Card */}
            <div className="mb-8 text-left">
              <Card className="w-full max-w-md mx-auto p-6 bg-white dark:bg-[#111827] border border-slate-200 dark:border-[#1f2937]">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white">Request Metrics</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-base font-medium text-slate-900 dark:text-white">OPS-2026-0042</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-base font-medium text-slate-900 dark:text-white">Operations Control Center</p>
                    </div>
                  </div>
                </div>
              </Card>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                onClick={() => navigate('/operations/track-request')}
                variant="primary"
