...
const OperationsLoginForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // For first time login simulate going to onboarding setup
      navigate('/operations/setup');
    }, 1500);
  };
    ...
    <div className="w-full">
      <div className="mb-8 text-center">
        ...
        <p className="text-slate-600 dark:text-slate-400">
          Secure access for authorized DGIIR personnel.
        </p>
      </div>
      ...
      >
        ...
        <Button 
          type="button" 
          onClick={() => navigate('/operations/request-access')}
          variant="outline" 
          fullWidth
...
export default OperationsLoginForm;
